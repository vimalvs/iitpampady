	...
	<footer id="colophon" class="site-footer <?php if($enlighten_footer_style == 'bottom'){echo 'bottom_menu';} ?>" role="contentinfo">
        ...
        <?php } ?>
            ...
            <div class="site-info">
                ...
                printf( wp_kses(__( 'WordPress Theme: %s by Accesspress Themes', 'enlighten' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) ,'<a target="_blank" href="https://accesspressthemes.com/wordpress-themes/enlighten/">Enlighten</a>' );
                ?>
        	</div><!-- .site-info -->
